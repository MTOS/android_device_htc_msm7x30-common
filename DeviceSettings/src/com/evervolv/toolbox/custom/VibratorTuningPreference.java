...
public class VibratorTuningPreference extends DialogPreference implements SeekBar.OnSeekBarChangeListener {
    ...
    public static final String FILE_PATH         = "/sys/class/timed_output/vibrator/voltage_level";
    public static final int MAX_VALUE            = 3100;
    public static final int WARNING_THRESHOLD    = 3000;
    public static final int DEFAULT_VALUE        = 3000;
